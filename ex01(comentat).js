...
var myCursor = db.restaurants.find()
    while (myCursor.hasNext()){
        printjson(myCursoriCursor.next())
	}
//2.Escriu una consulta per mostrar el restaurant_id, name, borough i cuisine per tots els documents en la col·lecció Restaurants.
var myCursor=db.restaurants.find({},{restaurant_id:1,name:1,borough:1})
	while(myCursor.hasNext()){
...
var myCursor=db.restaurants.find({},{_id:0,restaurant_id:1,name:1,borough:1,cuisine:1})
	while(myCursor.hasNext()){
		 printjson(myCursor.next())
	}
...
var myCursor=db.restaurants.find({},{_id:0,restaurant_id:1,name:1,borough:1,zipcode:1})
	while(myCursor.hasNext()){
		 printjson(myCursor.next())
	}
...
db.restaurants.find({"grades":{$elemMatch:{"score":{$lt:100,$gt:80}}}})
...
db.restaurants.find({cuisine:"Seafood",name:{$not:/^Wil/}},{restaurant_id:1,name:1,cuisine:1,borough:1,_id:0})
...
db.restaurants.find({"grades":{$elemMatch: {date:new Date("2014-08-11T00:00:00Z"),grade:"A",score:11}}},{restaurant_id:1,name:1,grades:1,_id:0})
...
db.restaurants.find({"grades.1.grade":"A","grades.1.score":9,"grades.1.date":new Date("2014-08-11T00:00:00Z")},{restaurant_id:1,name:1,grades:1,_id:0})
...
db.restaurants.find({"address.coord.1":{$gt:42,$lt:52}},{restaurant_id:1,name:1, address:1,borough:1,_id:0})
